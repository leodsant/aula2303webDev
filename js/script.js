...
// var numero = 1;
// // ctrl + d = seleciona a próxima palavra igual
// console.log(`A variável ${numero} tem o tipo ${typeof(numero)}`);

// var; //variável global ou local - tipo valor inicial pode ser nulo
...
console.log(maiorOuIgual, typeof(maiorOuIgual));

var diferente = 5 != 8;
console.log(diferente, typeof(diferente));
